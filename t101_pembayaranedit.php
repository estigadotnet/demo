...
<input type="text" data-table="t101_pembayaran" data-field="x_Tanggal" data-format="11" name="x_Tanggal" id="x_Tanggal" maxlength="19" placeholder="<?php echo HtmlEncode($t101_pembayaran_edit->Tanggal->getPlaceHolder()) ?>" value="<?php echo $t101_pembayaran_edit->Tanggal->EditValue ?>"<?php echo $t101_pembayaran_edit->Tanggal->editAttributes() ?>>
...
loadjs.ready(["ft101_pembayaranedit", "datetimepicker"], function() {
	ew.createDateTimePicker("ft101_pembayaranedit", "x_Tanggal", {"ignoreReadonly":true,"useCurrent":false,"format":11});
});
</script>
<?php } ?>
</span>
...
<div class="input-group ew-lookup-list">
	<div class="form-control ew-lookup-text" tabindex="-1" id="lu_x_loket_id"><?php echo EmptyValue(strval($t101_pembayaran_edit->loket_id->ViewValue)) ? $Language->phrase("PleaseSelect") : $t101_pembayaran_edit->loket_id->ViewValue ?></div>
	<div class="input-group-append">
		<button type="button" title="<?php echo HtmlEncode(str_replace("%s", RemoveHtml($t101_pembayaran_edit->loket_id->caption()), $Language->phrase("LookupLink", TRUE))) ?>" class="ew-lookup-btn btn btn-default"<?php echo ($t101_pembayaran_edit->loket_id->ReadOnly || $t101_pembayaran_edit->loket_id->Disabled) ? " disabled" : "" ?> onclick="ew.modalLookupShow({lnk:this,el:'x_loket_id',m:0,n:10});"><i class="fas fa-search ew-icon"></i></button>
	</div>
</div>
<?php echo $t101_pembayaran_edit->loket_id->Lookup->getParamTag($t101_pembayaran_edit, "p_x_loket_id") ?>
<input type="hidden" data-table="t101_pembayaran" data-field="x_loket_id" data-multiple="0" data-lookup="1" data-value-separator="<?php echo $t101_pembayaran_edit->loket_id->displayValueSeparatorAttribute() ?>" name="x_loket_id" id="x_loket_id" value="<?php echo $t101_pembayaran_edit->loket_id->CurrentValue ?>"<?php echo $t101_pembayaran_edit->loket_id->editAttributes() ?>>
</span>
...
<div class="input-group ew-lookup-list">
	<div class="form-control ew-lookup-text" tabindex="-1" id="lu_x_anggota_id"><?php echo EmptyValue(strval($t101_pembayaran_edit->anggota_id->ViewValue)) ? $Language->phrase("PleaseSelect") : $t101_pembayaran_edit->anggota_id->ViewValue ?></div>
	<div class="input-group-append">
		<button type="button" title="<?php echo HtmlEncode(str_replace("%s", RemoveHtml($t101_pembayaran_edit->anggota_id->caption()), $Language->phrase("LookupLink", TRUE))) ?>" class="ew-lookup-btn btn btn-default"<?php echo ($t101_pembayaran_edit->anggota_id->ReadOnly || $t101_pembayaran_edit->anggota_id->Disabled) ? " disabled" : "" ?> onclick="ew.modalLookupShow({lnk:this,el:'x_anggota_id',m:0,n:10});"><i class="fas fa-search ew-icon"></i></button>
	</div>
</div>
<?php echo $t101_pembayaran_edit->anggota_id->Lookup->getParamTag($t101_pembayaran_edit, "p_x_anggota_id") ?>
<input type="hidden" data-table="t101_pembayaran" data-field="x_anggota_id" data-multiple="0" data-lookup="1" data-value-separator="<?php echo $t101_pembayaran_edit->anggota_id->displayValueSeparatorAttribute() ?>" name="x_anggota_id" id="x_anggota_id" value="<?php echo $t101_pembayaran_edit->anggota_id->CurrentValue ?>"<?php echo $t101_pembayaran_edit->anggota_id->editAttributes() ?>>
</span>
