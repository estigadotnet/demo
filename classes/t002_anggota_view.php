 ...
 * Page class
 */
class t002_anggota_view extends t002_anggota
{
	...
	// Page object name
	public $PageObjName = "t002_anggota_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "t002_anggotalist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t002_anggotalist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t002_anggotalist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
