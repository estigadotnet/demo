 ...
 * Page class
 */
class t101_pembayaran_edit extends t101_pembayaran
{
	...
	// Page object name
	public $PageObjName = "t101_pembayaran_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// anggota_id
			$this->anggota_id->setDbValueDef($rsnew, $this->anggota_id->CurrentValue, 0, $this->anggota_id->ReadOnly);
