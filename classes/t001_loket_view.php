 ...
 * Page class
 */
class t001_loket_view extends t001_loket
{
	...
	// Page object name
	public $PageObjName = "t001_loket_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "t001_loketlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t001_loketlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t001_loketlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("t001_loketlist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
