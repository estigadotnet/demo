...
// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "p_iuran_1_0"); // Project name
...
$CONFIG = [
	...
	"RANDOM_KEY" => 'lWefz48gJh4bQTQh', // Random key for encryption
	...
	"PROJECT_ID" => "{7E72064D-658E-44EB-9361-513EC88D5A44}", // Project ID (GUID)
	...
	"CONNECTION_INFO" => [
		"DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "localhost", "port" => 3307, "user" => "root", "pass" => "admin", "db" => "db_iuran_1_0"]
	],
